...
SWIFT_PROTOCOL("_TtP6iProov18IProovViewDelegate_")
@protocol IProovViewDelegate
- (void)willPresentIProovView;
- (void)didPresentIProovView;
- (void)didDismissIProovView;
@end
...
@property (nonatomic, strong) id <IProovViewDelegate> _Nullable viewDelegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic) BOOL controlXPosition;
